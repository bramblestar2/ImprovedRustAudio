...
fn main() {
    ...
    fs::copy(cxx_path, "include/cxx.h").expect("Failed to copy cxx.h");
    fs::copy(api_h_path, "include/audio.h").expect("Failed to copy api.h");
    fs::copy(api_cc_path, "include/audio.cc").expect("Failed to copy api.cc");
}